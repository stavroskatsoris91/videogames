        ...
        function sendEmail() {
            ...
            $mdDialog.show({
                template: '<md-dialog ng-cloak aria-label="Test">' +
                    ...
                    '<md-content ng-include="\'/views/email_temlates/missing_card.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Non-Arrival-reply">' +
                    '<md-content ng-include="\'/views/email_temlates/reply.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Damaged-Cards">' +
                    '<md-content ng-include="\'/views/email_temlates/damaged_card.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Damaged-Envelope">' +
                    '<md-content ng-include="\'/views/email_temlates/damaged_envelope.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Positive Feedback">' +
                    '<md-content ng-include="\'/views/email_temlates/feedback.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Mistake on artwork">' +
                    '<md-content ng-include="\'/views/email_temlates/mistake.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Credit Card Fraud">' +
                    '<md-content ng-include="\'/views/email_temlates/fraud.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Returns from Royal Mail">' +
                    '<md-content ng-include="\'/views/email_temlates/returns.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '<md-tab label="Blank Direct">' +
                    '<md-content ng-include="\'/views/email_temlates/blank.html\'">' +
                    '</md-content>' +
                    '</md-tab>' +
                    '</md-tabs>' +
                    '<p class="text-right">' +
